                        ...
                        <nav id="main-nav" class="main-nav">
                            <ul id="menu-primary-menu" class="menu">
                                ...
                                <li class="menu-item menu-item-has-children" >
                                    ...
                                    <ul class="sub-menu ">
                                        <li class="menu-item"><a class="active" href="blog.html">Blog Standard</a></li>
                    ...
                    <div id="inner-content" class="inner-content-wrap">
                        ...
                        <article class="hentry data-effect">
                            <div class="post-media data-effect-item has-effect-icon offset-v-25 offset-h-24clerafix">
                                <a href="blog-detail.html"><img src="assets/img/post/post-2.jpg" alt="Image"></a>
                            </div><!-- /.post-media -->
                        ...
                        <article class="hentry margin-top-33 padding-top-45 data-effect">
                            <div class="post-media data-effect-item has-effect-icon offset-v-25 offset-h-24 clerafix">
                                <a href="blog-detail.html"><img src="assets/img/post/post-3.jpg" alt="Image"></a>
                            </div><!-- /.post-media -->
                        ...
                        <article class="hentry margin-top-33 padding-top-45 data-effect">
                            <div class="post-media data-effect-item has-effect-icon offset-v-25 offset-h-24 clerafix">
                                <a href="blog-detail.html"><img src="assets/img/post/post-4.jpg" alt="Image"></a>
                            </div><!-- /.post-media -->
