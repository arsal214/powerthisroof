...
<body class=" sidebar-left header-style-2 topbar-style-1 menu-has-search header-fixed">
...
<div id="wrapper" class="animsition">
    <div id="page" class="clearfix">
                    ...
                    <div class="wrap-inner clearfix">
                        ...
                        <nav id="main-nav" class="main-nav">
                            <ul id="menu-primary-menu" class="menu">
                                ...
                                <li class="menu-item menu-item-has-children">
                                    <a class="active down" href="service.html">Services</a>
                                    <ul class="sub-menu ">
                                        <li class="menu-item"><a href="service.html">Services</a></li>
                                        <li class="menu-item"><a class="active" href="service-detail.html">Services Details</a></li>
                                    </ul>
                                </li>
                                <li class="menu-item menu-item-has-children">
            ...
            <div id="header-banner-inner" class="container clearfix">
                <div class="header-banner-inner-wrap">
                    <div class="blog-standar-start">
                        <h1 class="blog-standar-start1">SERVICE DETAILS</h1>
                    </div>
                    <h2 class="blog-standar-end">
                        <a href="index.html" class="blog-standar-end">Home</a> |

                        <span class="blog-standar-end">Service Details</span>
                    </h2>
        ...
        <!-- Main Content -->
        <div id="main-content-2" class="site-main clearfix">
            <div id="content-wrap" class="container">
                <div id="sidebar">
                    <div id="inner-sidebar" class="inner-content-wrap">

                        <div class="widget widget_category style-2 widget no-sep">
                            <h3 class="widget-title"><span>Popular Service</span></h3>
                            <ul class="list-category">
                                <li><a href="service.html">Tempor lorem interdum</a></li>
                                <li><a href="service.html">Auctor mattis lacus </a></li>
                                <li><a href="service.html">Dolor proin </a></li>
                                <li><a href="service.html">Pharetra amet </a></li>
                                <li><a href="service.html">Nullam dolor gravida </a> </li>
                            </ul>
                        </div><!-- /.widget_category -->
                        ...
                        </div><!-- /.widget_get-a-quote -->

                        <div class="widget-company-profile">
                            <div class="widget-company-profile-inner-wrap">
                                <h3 class="title">Company Profile</h3>
                                <p class="infor-company">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt</p>
                    ...
                    <div id="inner-content" class="inner-content-wrap">
                        <article class="hentry data-effect">
                            <div class="post-media  clerafix">
                                <a href="service-detail.html"><img src="assets/img/shortcode/service-detail/service-detail-1.jpg" alt="Image"></a>
                            </div><!-- /.post-media -->

                            <div class="post-content-wrap clearfix">
                                <h1 class="post-title-detail style-2">
                                    <span class="post-title-inner">
                                        <span>PREDICTABLE PAYMENTS</span>
                                    </span>
                                </h1><!-- /.post-title -->

                                <div class="post-content margin-bottom-51">
                                    <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea </p>
                                    <p class="margin-top-19">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem</p>
                                </div><!-- /.post-excerpt -->

                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="post-img">
                                            <img src="assets/img/shortcode/service-detail/service-detail-2.jpg" alt="Image">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div>
                                            <h3 class="post-title-service-detail margin-top-4 ">
                                                <span class="post-title-inner">
                                                    Quality Control System
                                                </span>
                                            </h3><!-- /.post-title -->
                                            <div class="post-content margin-bottom-32">
                                                <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et</p>
                                            </div>
                                        </div>
                                        <div>
                                            <h3 class="post-title-service-detail ">
                                                <span class="post-title-inner">
                                ...
                                <div class="post-content margin-bottom-40">
                                    <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea </p>
                                </div><!-- /.post-excerpt -->

                                <div class="row-box-service-detail">
                                    <div class="col-service-detail">
                                        <div class="box-service-detail text-center">
                                            <div class="icon zingbox-icon-sola-plant margin-left-61"></div>
                                            <div class="title">Sign up</div>
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis at est id leo</p>
                                        </div>
                                    </div>
                                    <div class="col-service-detail">
                                        <div class="box-service-detail active text-center">
                                            <div class="icon zingbox-icon-Solar-power-lamp margin-left-66"></div>
                                    ...
                                    <div class="col-service-detail">
                                        <div class="box-service-detail text-center">
                                            <div class="icon zingbox-icon-Solar-power-light margin-left-78"></div>
                            ...
                            <ul class="lastest-posts data-effect clearfix">
                                <li class="clearfix">
                                    ...
                                    <div class="text">
                                        ...
                                        <h4><a href="service-detail.html">Bigg Ideas Of Business
                                            branding Info.</a></h4>
                                    </div>
                                </li>
                                <li class="clearfix">
